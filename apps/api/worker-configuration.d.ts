/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0fe313b8e9ea8a556497c458e34d4824)
// Runtime types generated with workerd@1.20260801.1 2026-08-08 nodejs_compat
interface __BaseEnv_Env {
	EMAIL: SendEmail;
	EMAIL_FROM: "no-reply@rubik.sachi.dev";
	DATABASE_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "EMAIL_FROM" | "DATABASE_URL" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "APP_URL">> {}
}
